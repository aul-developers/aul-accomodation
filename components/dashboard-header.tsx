      ...
      <div className="flex items-center gap-3 md:gap-6">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <div className="h-10 w-10 md:h-9 md:w-9 rounded-full bg-[#5d2b5c] flex items-center justify-center text-white font-bold ring-4 ring-white shadow-lg shadow-purple-900/10 group-hover:scale-105 transition-transform">
                JD
              </div>
